...
RSpec.describe ReviewsController, :type => :routing do
  describe "routing" do
    ...
    it "routes to #draftsave" do
      expect(:post => "/reviews/1/draftsave").to route_to("reviews#draftsave", :id => "1")
    end

    it "routes to #invite_handler" do 
      expect(:post => "/reviews/invite_handler").to route_to("reviews#invite_handler")
    end
